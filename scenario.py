...
class SCENARIO:
    ...
    def set_traffic_manger(self, synchronous=True):
        ...
        self.traffic_manager.ignore_lights_percentage(self.aggressive_car_percenatge)
        self.traffic_manager.ignore_vehicles_percentage(self.aggressive_car_percenatge)
        ...
        for _ in range(self.num_nv)
            spawn_point = platton_spawn_points[self.type]
